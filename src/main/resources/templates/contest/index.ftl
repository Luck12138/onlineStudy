...
<div class="f-main clearfix">
    ...
    <div class="types-block clearfix" style="padding:0px;">
        <h3 style="margin-bottom: 20px;">
            <span class="types-title" style="margin-right:40px;">试题列表</span>
        </h3>
            ...
            <#if page.items??>
                    ...
                    <div>
                        <#list page.items as item>
                            ...
                            <a href="/contest/detail/${item.id}" target="_blank">
                                            ...
                                            <div class="course-card-top purple-bg">
                                                ...
                                                <div class="course-card-top gray-bg">
                                                    ...
                                                    <div class="course-card-content">
                                                        <h3 class="course-card-name" title="${item.title!}">${item.title!}</h3>
                                                        <div class="course-card-bottom">

                                                                    <span>·</span>总分：${item.totalScore!}
                                                        </div>
                                                    </div>
                                                </div>
                            </a>
