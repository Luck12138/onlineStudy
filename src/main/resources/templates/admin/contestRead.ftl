                                ...
                                <td style="width:600px;">
                                    <p>
                                        ...
                                        <div class="ml-15 w-350" style="float:left;">
                                            <a href="/admin/contestRead?id=${item.id!}">
                                    <p class="ellipsis"  title="${item.content!}"><strong>${item.content!}</strong></p>
                                    </a>
    ...
    <div class="modal_wapper">
        <div class="modal-dialog w-8" >
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" id="myFormQuestion" method="post" action="/admin/questionSave1?contestId=#{id!}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="score" id="score" placeholder="分值">
                        </div>
                        <div class="form-group">
